	...
	if (!pubkey) {
		return (
			<div className="space-y-6 p-4 lg:p-8">
				<h1 className="font-bold text-2xl">Nostr Address (NIP-05)</h1>
							...
							<Card>
								...
								<CardContent className="space-y-4">
									...
									<div className="flex items-center gap-2">
										...
										<span className="text-muted-foreground text-sm">Expires: {formatExpiration(currentNip05.validUntil).date}</span>
