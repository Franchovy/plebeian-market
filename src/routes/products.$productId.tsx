...
import { EntityActionsMenu } from '@/components/shared/entity/EntityActionsMenu'
import { ImageCarousel } from '@/components/features/home/ImageCarousel'
import { ImageViewerModal } from '@/components/features/product/ImageViewerModal'
import { ItemGrid } from '@/components/shared/ItemGrid'
import { PriceDisplay } from '@/components/shared/product/PriceDisplay'
				...
				<div className="z-20 relative mx-auto -mt-12 px-4 py-6 max-w-7xl">
					{isMobileOrTablet ? (
						...
						<Tabs defaultValue={TabProductPage.description} value={currentTab} className="w-full">
							<TabsList className="flex flex-wrap justify-start gap-2 bg-transparent p-0 w-full h-auto">
