...
import { classNameButtonBorderHighlight } from './ui/ButtonExtended'
					...
					{localSrc ? (
						<>
							<div className="absolute inset-0 opacity-10">
								<div
									className="absolute inset-0 bg-gradient-to-r from-gray-300 to-white"
									style={{ clipPath: 'polygon(0 0, 100% 0, 0 100%)' }}
								></div>
								<div
									className="absolute inset-0 bg-gradient-to-l from-gray-300 to-white"
							...
							<div
								...
								style={{ backgroundImage: 'url("images/image-bg-pattern.png")', backgroundRepeat: 'repeat' }}
							>
				...
				<div className="relative w-full">
					...
					{localSrc ? (
						inputEditable ? (
							<Button
								type="button"
								className={classNameButtonBorderHighlight + ' absolute right-1 top-1 bottom-1 h-10'}
						...
						<Button
							type="button"
							className={classNameButtonBorderHighlight + ' top-1 right-1 bottom-1 absolute h-10'}
							onClick={handleSaveImage}
							data-testid="image-save-button"
						>
							Save
