		...
		>
					...
					{isLoadingZapInfo ? (
						...
						<>
							{zapInfo.hasLightning && (
								<Tooltip>
									<TooltipTrigger>
										<Badge variant="outline" className="gap-1 bg-yellow-50 px-1.5 border-yellow-300 h-6 text-yellow-600">
							...
							{zapInfo.hasCashu && (
								<Tooltip>
									<TooltipTrigger>
										<Badge variant="outline" className="gap-1 bg-green-50 px-1.5 border-green-300 h-6 text-green-600">
						...
						<Tooltip>
							<TooltipTrigger>
								<Badge variant="outline" className="px-1.5 border-muted h-6 text-muted-foreground">
			...
			<CollapsibleContent>
				<div className="px-3 pb-4">
					<div className="mb-2 text-muted-foreground text-sm">Adjust percentage</div>
