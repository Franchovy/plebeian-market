	...
	return (
		<div className="mx-auto px-4 py-4 container">
			<div className="space-y-6">
					...
					<Card>
						...
						<CardContent>
							<div className="space-y-4">
								...
								{isDigitalService && (
									<div className="bg-purple-50 mt-4 p-4 border border-purple-200 rounded-lg">
										<div className="flex items-start gap-2">
											<Download className="mt-0.5 w-4 h-4 text-purple-600" />
											<div>
												<p className="font-medium text-purple-900">Digital Delivery</p>
												<p className="mt-1 text-purple-800 text-sm">
								...
								{shippingInfo?.description && (
									<div className="bg-gray-50 mt-4 p-3 rounded-lg">
										<p className="text-gray-700 text-sm">{shippingInfo.description}</p>
									</div>
								)}
							</div>
						</CardContent>
						...
						<CardHeader className="p-0">
							<div className="bg-gray-50 p-4 rounded-t-xl">
								<div className="flex items-start gap-2">
									...
									<div className="flex sm:flex-row flex-col sm:items-baseline sm:gap-2">
										<CardTitle>Payment Details</CardTitle>
										<span className="text-muted-foreground">({totalInvoices} invoices)</span>
									</div>
								</div>
								<div className="sm:hidden my-3 border-gray-300 border-b" />
				...
				{allEvents.length > 0 && (
					<div>
						<h2 className="mb-4 font-bold text-xl">Order Timeline</h2>
						<div className="space-y-4">
