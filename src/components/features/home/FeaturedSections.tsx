import { CollectionCard } from '@/components/features/home/CollectionCard'
import { FeaturedUserCard } from '@/components/features/home/FeaturedUserCard'
	...
	if (isLoading) {
		return (
			<div className="animate-pulse">
				<div className="bg-gray-200 mb-2 rounded-lg aspect-square"></div>
				<div className="bg-gray-200 mb-1 rounded h-4"></div>
	...
	return (
		<div className={cn('w-full max-w-full overflow-hidden', className)}>
			...
			{displayProducts.length > 0 && (
				<section className={cn('py-12 w-full max-w-full overflow-hidden', sectionIndex++ % 2 === 0 ? 'bg-transparent' : 'bg-off-black')}>
					<div className="px-4 sm:px-8 max-w-full">
						<div className="flex sm:flex-row flex-col sm:justify-between sm:items-center gap-2 mb-6">
							<div className="flex items-center gap-3">
								...
								<h2 className="font-heading text-xl sm:text-2xl">Featured Products</h2>
							</div>
					...
					<div className="px-4 sm:px-8 max-w-full">
						<div className="flex sm:flex-row flex-col sm:justify-between sm:items-center gap-2 mb-6">
							<div className="flex items-center gap-3">
								...
								<h2 className="font-heading text-white text-xl sm:text-2xl">Featured Collections</h2>
							</div>
					...
					<div className="px-4 sm:px-8 max-w-full">
						<div className="flex sm:flex-row flex-col sm:justify-between sm:items-center gap-2 mb-6">
							<div className="flex items-center gap-3">
								...
								<h2 className="font-heading text-xl sm:text-2xl">Featured Sellers</h2>
							</div>
						</div>
