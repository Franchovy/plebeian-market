			...
			<div className="gap-6 grid grid-cols-1 lg:grid-cols-2">
							...
							<div>
								...
								<div className="gap-2 grid grid-cols-2 mt-2">
									{nip15Data.images.map((url, index) => (
										<img key={index} src={url} alt={`Product image ${index + 1}`} className="border rounded w-full h-32 object-cover" />
									))}
								</div>
							</div>
						)}
				...
				<Card>
					...
					<CardContent className="space-y-4">
						<div>
							<Label htmlFor="name">
								<span className="after:ml-0.5 after:text-red-500 after:content-['*']">Product Name</span>
							</Label>
							<Input
								id="name"
								value={formData.name}
						...
						<div className="gap-4 grid grid-cols-2">
							<div>
								<Label htmlFor="price">
									<span className="after:ml-0.5 after:text-red-500 after:content-['*']">Price</span>
								</Label>
								<Input
									id="price"
									type="number"
							...
							<div>
								<Label htmlFor="currency">
									<span className="after:ml-0.5 after:text-red-500 after:content-['*']">Currency</span>
								</Label>
						...
						<div>
							<Label>
								<span className="after:ml-0.5 after:text-red-500 after:content-['*']">Images</span>
							</Label>
							<div className="space-y-2 mt-2">
						...
						{formData.mainCategory && (
							<div>
								...
								<p className="mt-1 mb-2 text-gray-500 text-sm">Add sub-categories to better describe your product</p>
						...
						<div>
							...
							<p className="mt-1 mb-2 text-gray-500 text-sm">Select shipping methods available for this product</p>
							{isLoadingShipping ? (
								...
								<p className="text-gray-500 text-sm">No shipping options configured. You can add them in Dashboard → Shipping Options</p>
							) : (
								<div className="space-y-2">
									{/* Selected shipping options */}
									{formData.shippings.length > 0 && (
										<div className="space-y-2 mb-3">
											<Label className="text-gray-600 text-sm">Selected:</Label>
											{formData.shippings.map((shipping, index) => (
												<div key={index} className="flex items-center gap-2 bg-gray-50 p-2 border rounded">
						...
						<div>
							...
							<p className="mt-1 mb-2 text-gray-500 text-sm">Format: Length x Width x Height</p>
						...
						<div>
							...
							<p className="mt-1 mb-2 text-gray-500 text-sm">Assign this product to a collection</p>
							{isLoadingCollections ? (
								...
								<p className="text-gray-500 text-sm">No collections found. You can create collections in Dashboard → Collections</p>
							) : (
								<Select
